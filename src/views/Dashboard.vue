    ...
    <div class="dashboard">
        ...
        <div class="commands">
            <div class="command" v-for="command of commands" :key="command._id">
                ...
                <div class="buttons">
                    <btn @click="onModifyCmdClick(command)" variant="primary"
                        >Modify</btn
                    >
                    <btn @click="onDeleteCmdClick(command)" variant="danger"
                        >Delete</btn
                    >
                </div>
            </div>
        ...
        >
            ...
            <div class="buttons">
                <btn
                    ...
                    >SAVE</btn
                >
                <btn @click="onCreateChoiceClick(false)" class="btn"
                    >CANCEL</btn
                >
            </div>
        </popup>
        ...
        >
            ...
            <div class="buttons">
                <btn
                    ...
                    >SAVE</btn
                >
                <btn @click="onModifyChoiceClick(false)" class="btn"
                    >CANCEL</btn
                >
            </div>
        </popup>
        ...
        >
            <h3>
                Are you sure you want to delete "{{ selectedCommand.name }}"?
            </h3>
            <hr />
            <div class="buttons">
                <btn
